...
insert into address (id, street, number, district, city, zip_code, state, is_main) values (3, 'Av. Brigadeiro Faria Lima', '120', 'Centro', 'Sao Paulo', '24110-010', 'SP', true);
insert into address (id, street, number, district, city, zip_code, state, is_main) values (4, 'Rua Joal de Lima e Silva', '321', 'Vila Julia', 'Uruguaiana', '97500-350', 'RS', false);
insert into address (id, street, number, district, city, zip_code, state, is_main) values (5, 'Rua Monte Caseros', '42', 'Vila Silvia Regina', 'Campo Grande', '79103-170', 'MS', false);
...
insert into customer (id, name, email, register_number, type, phone_number) values (3, 'Super Empresa', 'superempresa@email.com', '33.014.556/0001-96', 'JURIDICAL_PERSON', '98817-9809');
