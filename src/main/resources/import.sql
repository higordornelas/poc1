...
insert into address (id, street, number, district, city, zip_code, state) values (3, 'Av. Rebouças', '120', 'Centro', 'Sao Paulo', '24110-010', 'SP');
insert into address (id, street, number, district, city, zip_code, state) values (4, 'Rua Joal de Lima e Silva', '321', 'Vila Júlia', 'Uruguaiana', '97500-350', 'RS');
insert into address (id, street, number, district, city, zip_code, state) values (5, 'Rua Monte Caseros', '42', 'Vila Sílvia Regina', 'Campo Grande', '79103-170', 'MS');
